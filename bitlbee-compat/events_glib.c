...
guint b_input_add(gint source, b_input_condition condition, b_event_handler function, gpointer data)
{
...
guint b_timeout_add(gint timeout, b_event_handler func, gpointer data)
{
